...
public class LoginActivity extends AppCompatActivity {
    ...
    //Variavel de usuário
    private final User usuario = new User("", "", false);
    ...
    protected void onStart() {
        super.onStart();
        //Verificando login
        mAuth = FirebaseConfig.Companion.getFirebaseAuth();
        //preenchendo usuário, opcional, pode utilizar-se as props do próprio FirebaseAuth
        mUser = FirebaseConfig.Companion.getFirebaseAuth().getCurrentUser();
        //Se já está logado, vai p outra tela
        if (mUser != null) validarCadastro();
        //Configurando Login
        loginGoogle = new LoginGoogle();
        mGoogleSignInClient = loginGoogle.configurarGoogle(
                "275890153034-ve8r244gk155cn5e21cccmjt5et58ijq.apps.googleusercontent.com", this);
        ...
        if (requestCode == GOOGLE_SIGN) {
            ...
            try {
                ...
                if (conta != null) {
                    ...
                    Toast.makeText(loginGoogle, "Conta Google nula... Por favor, tente novamente.", Toast.LENGTH_SHORT).show();

                }

            } catch (ApiException e) {
                Log.e("LoginActivity", "Falha: " + e.getMessage());
                e.printStackTrace();
            }
    ...
    private void solicitaNomeCadastro(User usuarioCadastrado) {
        EditText editNome;
        Button btnCadastrar;
        ...
        btnCadastrar.setOnClickListener(view -> {
            ...
            if (editNome.getText().toString().isEmpty()) {
                ...
                usuario.setName(editNome.getText().toString());
                dialogNome.dismiss();
            }
        });
    ...
    private void startTimeControlActivity() {
    ...
    private void validarCadastro() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (mUser != null) {
                    usuariosDAO = new UserDAO(LoginActivity.this);
